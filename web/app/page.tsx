  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <section className="relative pt-24 pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-background -skew-y-6 z-0"></div>
        <div className="relative container mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 text-left">
            ...
            <div className="flex gap-4">
              {/* <Link href={"/test"}>
                <button className="relative bg-primary text-primary-foreground px-6 py-3 rounded-md font-medium text-base hover:bg-primary/90 transition-all duration-300 group flex items-center gap-2">
          ...
          <div className="lg:w-1/2 relative">
            <div className="bg-card/50 border border-border rounded-xl p-8 max-w-sm lg:max-w-md mx-auto lg:ml-auto shadow-lg transform -rotate-2 hover:rotate-0 transition-transform duration-500">
              <p className="text-muted-foreground italic">
                “x8x turned my chaotic workflow into a masterpiece.” — A happy
                user
              </p>
            </div>
          </div>
      ...
      {/* Features Section - Linear, Varied-Width Cards with Colored Borders */}
      <section
        id="features"
      ...
      {/* Integrations Section - Horizontal, Consistent Cards with Gradient Hover */}
      <section
        id="integrations"
        className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 relative"
      >
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 relative">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-background -skew-y-3 z-0"></div>
      ...
      <footer className="border-t border-border/50 py-10 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-6">
          ...
          <p className="text-sm text-muted-foreground">
            © 2025 x8x. Crafted for automation lovers.
          </p>
        </div>
      </footer>
    </div>
